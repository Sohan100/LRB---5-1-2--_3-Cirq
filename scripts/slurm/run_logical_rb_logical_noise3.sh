#!/bin/bash
#SBATCH --job-name=qutrit_rb_logical_noise_parallel
#SBATCH --output=qutrit_rb_logical_noise_parallel_%j.out
#SBATCH --error=qutrit_rb_logical_noise_parallel_%j.err
#SBATCH -C cpu
#SBATCH -q regular
#SBATCH -t 47:30:00
...
CHECKPOINT_DIR="results/qutrit_rb_results_logical_depolarizing_noise_noise"
SCRIPTS_DIR="/global/homes/s/sohan100/qutrit_simulation/scripts"
SIM_SCRIPT="${SCRIPTS_DIR}/qutrit_logical_rb_logical_noise_sim.py"
REPS=10000
