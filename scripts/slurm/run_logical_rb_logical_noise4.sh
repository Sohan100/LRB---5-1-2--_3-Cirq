#!/bin/bash
#SBATCH --job-name=qutrit_rb_logical_noise_parallel_alt
#SBATCH --output=qutrit_rb_logical_noise_parallel_alt_%j.out
#SBATCH --error=qutrit_rb_logical_noise_parallel_alt_%j.err
#SBATCH -C cpu
#SBATCH -q regular
#SBATCH -t 47:30:00
...
CHECKPOINT_DIR="results/qutrit_rb_results_alternate"
