    ...
    def __init__(
        ...
        Raises:
            ValueError: If supplied argument values violate this method's input
                        assumptions.
        """
        self.logical_checkpoint_dir = os.fspath(
            resolve_project_path(logical_checkpoint_dir, prefer_results=True)
        )
        self.experiment_name = experiment_name
        self.output_dir = os.fspath(
            resolve_project_path(
                output_dir or self.logical_checkpoint_dir,
                prefer_results=True,
            )
        )
...
Raises:
    ...
    ValueError: If plotting inputs are inconsistent with expected data shapes
                or keys.
"""
        physical_results_path = os.fspath(
            resolve_project_path(physical_results_path, prefer_results=True)
        )
